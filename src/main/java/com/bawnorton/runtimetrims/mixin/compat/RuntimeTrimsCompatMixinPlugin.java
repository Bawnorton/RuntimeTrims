package com.bawnorton.runtimetrims.mixin.compat;
...
public final class RuntimeTrimsCompatMixinPlugin implements IMixinConfigPlugin {
    private static final Logger LOGGER = LoggerFactory.getLogger(RuntimeTrimsCompatMixinPlugin.class);
